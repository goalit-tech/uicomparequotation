...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "nlab/ai/uicomparequotation/test/integration/FirstJourney",
    "nlab/ai/uicomparequotation/test/integration/QuotationComparisonListJourney",
    "nlab/ai/uicomparequotation/test/integration/QuotationComparisonObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
